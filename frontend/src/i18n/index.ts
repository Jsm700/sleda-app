...
const translations = {
  bg: {
    ...
    pendingTitle: "Незапазен маршрут",
    pendingBody: "Последният маршрут не е качен заради проблем със сървъра. Да опитаме сега?",
    pendingUpload: "Качи",
    pendingDiscard: "Изтрий",
    pendingDiscardTitle: "Сигурен ли си?",
    pendingDiscardConfirm: "Да, изтрий го",
    ...
    walkMode: "Разходка",
    boatMode: "Лодка",
    shoreAlertModalTitle: "Известия за брега",
    shoreAlertWhenLabel: "Кога да ме известиш",
    shoreAlertOff: "Изключено",
    shoreAlertCloser: "При приближаване",
    shoreAlertFarther: "При отдалечаване",
    shoreAlertDistanceLabel: "На какво разстояние",
    shoreBadgeDefault: "Известия за брега",
    shoreBadgeSuffix: "до брега",
    shoreUnitM: "м",
    shoreUnitKm: "км",
  ...
  en: {
    ...
    pendingTitle: "Unsaved trip",
    pendingBody: "Your last trip couldn't be uploaded due to a server issue. Try now?",
    pendingUpload: "Upload",
    pendingDiscard: "Discard",
    pendingDiscardTitle: "Are you sure?",
    pendingDiscardConfirm: "Yes, discard",
    ...
    walkMode: "Walk",
    boatMode: "Boat",
    shoreAlertModalTitle: "Shore alerts",
    shoreAlertWhenLabel: "When to notify me",
    shoreAlertOff: "Off",
    shoreAlertCloser: "Getting closer",
    shoreAlertFarther: "Getting farther",
    shoreAlertDistanceLabel: "At what distance",
    shoreBadgeDefault: "Shore alerts",
    shoreBadgeSuffix: "to shore",
    shoreUnitM: "m",
    shoreUnitKm: "km",
